...
class SimpleCNN(Module):
    def __init__(self):
        ...
        self.conv1 = Conv3d(in_channels=1, out_channels=hidden_channels, kernel_size=7, stride=1, padding=1)
        self.conv2 = Conv3d(in_channels=hidden_channels, out_channels=hidden_channels, kernel_size=5, stride=1, padding=1)
